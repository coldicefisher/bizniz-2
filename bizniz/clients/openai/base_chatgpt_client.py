...
from bizniz.clients.openai.messages import Message, MessageList, normalize_messages
from bizniz.clients.base_ai_client import BaseAIClient
from bizniz.clients.openai.types.response_format import ResponseFormat
...
class BaseChatGPTClient(BaseAIClient):
    ...
    def get_text(
        ...
        try:
            ...
            from bizniz.clients.openai.errors import OpenAIContextLengthExceeded
            error_msg = str(e).lower()
