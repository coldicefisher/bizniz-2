"""
Functional tests: verify Coder can generate code via real API calls.

Run with:
    pytest bizniz/coder/tests/functional/ -m functional -v
"""
import pytest
...
def test_generate_single_file(api_key, workspace_path):
    ...
    coder = Coder(client=client, environment=environment, workspace=workspace)
