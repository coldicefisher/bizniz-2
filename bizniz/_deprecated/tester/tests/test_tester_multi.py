"""
Tests for Tester multi-file test generation.
"""
import json
import pytest
...
from bizniz.tester.types import TesterBadAIResponseError
...
class TestGenerateMulti:
    ...
    def test_returns_all_test_files(self, tester):
    ...
    def test_saves_all_test_files_to_workspace(self, tester, mock_workspace):
        tester.generate_multi(
            problem_statement="Build expense tracker",
            test_files=["tests/test_models.py", "tests/test_cli.py"],
        )
    ...
    def test_uses_tool_loop_with_discovery(self, tester, mock_client, mock_workspace):
    ...
    def test_raises_on_empty_response(self, tester, mock_client):
    ...
    def test_raises_on_empty_test_files(self, tester, mock_client):
        empty_response = {
    ...
    def test_mode_is_from_prompt(self, tester):
        result = tester.generate_multi(
            problem_statement="Build tracker",
            test_files=["tests/test_models.py"],
        )
...
class TestGenerateTestsSingleFileFallback:
    ...
    def test_handles_test_files_array(self, tester, mock_client):
        response = {
    ...
    def test_handles_old_tests_string(self, tester, mock_client):
        response = {
