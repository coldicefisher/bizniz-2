...
class CoderProcessError(Exception):
    pass


class CoderBadAIResponseError(CoderProcessError):
    pass
...
class CoderAIVerificationResult(BaseModel):
    is_valid: bool
    code: Optional[str] = None
    errors: Optional[List[str]] = None


class CoderFailedError(BaseModel):
    error: str
    code: str
...
class CoderOnEventCallback(BaseModel):
